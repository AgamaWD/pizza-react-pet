...
function Search() {
    ...
    return (
        <div className="search">
            ...
            {
                searchValue &&
                <span onClick={() => setSearchValue('')} className="search__icon search__icon--close">
            ...
            <input value={searchValue} onChange={e => setSearchValue(e.target.value)} type="text" placeholder="Поиск" className="search__input" />
        </div>
    )
}
